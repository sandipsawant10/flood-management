...
import { getFinancialAidRequests, reviewFinancialAidRequest } from '../../services/financialAid';
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="divide-y">
            {requests?.map((request) => (
              <div
                key={request._id}
                className={`p-4 cursor-pointer transition-colors ${selectedRequest?._id === request._id ? 'bg-blue-50' : 'hover:bg-gray-50'}`}
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Amount: PHP {request.amountRequested.toLocaleString()}
                    </p>
                  </div>
                  <span
