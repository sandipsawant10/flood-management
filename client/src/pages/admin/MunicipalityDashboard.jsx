...
import { MapPin, Bell, AlertTriangle, Users, CheckCircle, XCircle, Clock } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Manage flood reports, alerts, and emergency response</p>
      </div>
